...
<!--                        <span class="carousel-bg"></span>-->
            ...
            <div class="content-block new-content">
                    ...
                    <div v-for="article in articles" :key="article.id">
                        <div class="news-list">
                            <div class="news-img col-xs-5 col-sm-5 col-md-4"><a target="_blank" href=""><img
                                    :src="article.articleCover" alt=""> </a></div>
                            <div class="news-info col-xs-7 col-sm-7 col-md-8">
                                <dl>
                                    <dt>
                                        <router-link :to="{name:'content-id',params:{id: article.id}}">
                                            {{article.articleTitle}}
                                        </router-link>

                                    </dt>
                                    <dd><span class="name"><a href="" title="由 异清轩 发布" rel="author">异清轩</a></span> <span
                                            class="identity"></span> <span class="time"> {{article.articleDate}} </span>
                                    </dd>
                                ...
                                <div class="news_bot col-sm-7 col-md-8"><span class="tags visible-lg visible-md"> <a
                                        href="">本站</a> <a href="">异清轩</a> </span> <span
                ...
                <div class="quotes" style="margin-top:15px"><span class="disabled">首页</span><span
                        class="disabled">上一页</span><span class="current">1</span><a href="">2</a><a href="">下一页</a><a
                        href="">尾页</a></div>
            </div>
        </div>
    </div>
